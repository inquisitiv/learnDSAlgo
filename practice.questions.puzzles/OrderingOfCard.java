...
public class OrderingOfCard{
    ...
    private static class dimension  implements Comparable<dimension>
    {
    	...
    	public dimension(int[][] a, char c, int area,int visibilty, int h,int v)
    	{
    		getDimension = a;
    		this.c=c;
    	    this.area = area;
    	...
    	private class dimensionComparator implements Comparator<dimension>{
			...
			public int compare(dimension o1, dimension o2) {
				...
				if(Arrays.deepEquals(o1.getDimension, o2.getDimension))
				{
				...
				else if(o1.getDimension[1][0]<o2.getDimension[0][0] || o2.getDimension[1][0]<o1.getDimension[0][0] || o1.getDimension[1][1]<o2.getDimension[0][1] || o2.getDimension[1][1]<o1.getDimension[0][1])
				{
					return equals(o1,o2);
				}				
	...
	public static String findOrder(String[] grid)
	{
		...
		{ 
			...
			for(int j=0;j<len;j++)
			{
				...
				{				
				if(map.isEmpty())
				map.put(grid[i].toCharArray()[j],new dimension(new int[][]{{i,j},{i,j}},grid[i].toCharArray()[j],0,1,0,0));
			...
			{
				temp = new dimension(x.getDimension,x.c,x.area,x.visibility,x.hf,x.vf);
				answer.add(temp);
	...
	public static void main(String[] args) {
		...
		System.out.println(findOrder(new String[]{"bbb666",".655X5","a65AA5","a65AA5","a65555"}));
		System.out.println(findOrder(new String[]{"..vA..","..Av.."}));
